<x-app-layout title="Forms">
    <div class="container mx-auto mt-8 p-4 mb-4 dark:bg-gray-700 dark:rounded-lg font-serif bg-gray-20 rounded-lg shadow-lg">
        <div class="modal-header flex justify-between items-center">
            <h3 class="text-2xl dark:text-gray-200 text-gray-800 font-semibold">Edit {{$animal->name}} Treatment</h3>
        </div>
        <div class="modal-body">

            <form action="{{ route('treatment.update', ['animal_id' => $animal->id, 'treatment_id' => $treatment->id]) }}" method="POST" >
                @csrf <!-- Add CSRF token -->
                @method('PUT')
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-4">
                    <div class="col-span-1">
                        ...
                        <select class="form-select  dark:bg-gray-700 dark:text-gray-200 w-full mt-2" required="required" value="{{$treatment->type}}" name="type" id="treatment_type">
                    ...
                    <div class="col-span-1">
                        ...
                        <input class="form-input mt-1 dark:bg-gray-700 dark:text-gray-200 " maxlength="60" size="60" value="{{$treatment->product}}" type="text" name="product" id="treatment_product">
                    </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-4">
                    <div class="col-span-1">
                        ...
                        <input class="form-input dark:bg-gray-700 dark:text-gray-200  mt-1" maxlength="63" size="63" value="{{$treatment->batch}}" max="100000" type="text" name="batch" id="treatment_batch">
                    </div>
                    <div class="col-span-1 md:mt-0">
                        ...
                        <input class="form-input dark:bg-gray-700 dark:text-gray-200 mt-1" maxlength="60" size="60" value="{{$treatment->amount}}"  type="text" name="amount" id="treatment_amount">
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-4">
                    ...
                    <div class="col-span-1">
                        ...
                        <div class="flex dark:bg-gray-700 dark:text-gray-200 mt-1">
                            <input class="form-input dark:bg-gray-700 dark:text-gray-200  flex-grow" placeholder="" step="any" type="number" value="{{$treatment->inventory_amount}}" max="10000000" name="inventory_amount" id="treatment_inventory_amount">
                            <select class="form-select dark:bg-gray-700 dark:text-gray-200 ml-2" value="{{$treatment->unit}}" name="unit" id="treatment_unit">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-4">
                    <div class="col-span-1">
                        ...
                        <select class="form-select dark:bg-gray-700 dark:text-gray-200 w-full mt-1" value="{{$treatment->mode}}" name="mode" id="treatment_mode">
                            <option value="{{$treatment->mode}}">{{$treatment->mode}}</option>
...
<option value="Other">Other</option>
                    ...
                    <div class="col-span-1">
                        ...
                        <input class="form-input dark:bg-gray-700 dark:text-gray-200  mt-1" maxlength="60" placeholder="Rump, Flank,Neck" size="60" value="{{$treatment->site}}" type="text" name="site" id="treatment_site">
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-4">
                    <div class="col-span-1">
                        ...
                        <input type="number" name="days_to_withdrawal" id="days_to_withdrawal" value="{{$treatment->days_to_withdrawal}}" class="form-input w-full dark:bg-gray-700 dark:text-gray-200  mt-1" min="0" max="9999">
                    </div>
                    <div class="col-span-1">
                        <label for="treatment_retreat_date" class="block dark:text-gray-100  text-sm font-medium text-gray-700">Booster Date</label>
                        <input class="form-input w-full dark:bg-gray-700 dark:text-gray-200 mt-1" value="{{$treatment->retreat_date}}" type="date" name="retreat_date" id="treatment_retreat_date">
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-4">
                    <div class="col-span-1">
                        ...
                        <input class="form-input dark:bg-gray-700 dark:text-gray-200 mt-1" placeholder="Example: Alpine Vet, etc" maxlength="63" size="63" value="{{$treatment->technician}}" type="text" name="technician" id="treatment_technician">
                    </div>
                    <div class="col-span-1">
                        ...
                        <div class="mt-1 dark:bg-gray-700 dark:text-gray- flex items-center">
                            <select class="form-select dark:bg-gray-700 dark:text-gray-200  mr-2" value="{{$treatment->currency}}" name="currency" id="treatment_currency">
                            ...
                            <input class="form-input dark:bg-gray-700  dark:text-gray-100  flex-grow" step=".1" min="0" max="1000000" value="{{$treatment->cost}}" type="number" name="cost" id="treatment_cost">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-4">
                    ...
                    <div class="col-span-1 ">
                        ...
                        <div class="mt-1 flex items-center">
                            ...
                            <input class="form-input dark:bg-gray-700 dark:text-gray-200 flex-grow w-full ml-2" placeholder="Example: monthly application, etc" maxlength="20" size="20" value="{{$treatment->treatment_keywords}}" type="text" name="treatment_keywords" id="treatment_keywords">
                        </div>
                    </div>
                </div>
