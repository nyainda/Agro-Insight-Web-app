                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div class="mb-4">
                        ...
                        <div class="input-group">
                            <input class="form-input dark:bg-gray-700 dark:text-gray-200 mt-2 w-full" placeholder="Enter Weight" max="100000" step="any" value="{{$measurement->weight}}" type="number" name="weight" id="measurement_weight">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="input-group">
                            <input class="form-input mt-2 dark:bg-gray-700 dark:text-gray-200 w-full" placeholder="" step="any" max="1000" type="number" value="{{$measurement->height}}" name="height" id="measurement_height">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="input-group">
                            <input class="form-input mt-2 dark:bg-gray-700 dark:text-gray-200 w-full" step=".5" min="0" max="100" value="{{$measurement->condition_score}}" type="number" name="condition_score" id="measurement_condition_score">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="input-group">
                            <input class="form-input mt-2 dark:bg-gray-700 dark:text-gray-200 w-full" step=".5" min="0" max="200" value="{{$measurement->temp}}" type="number" name="temp" id="measurement_temp">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="input-group">
                            <input class="form-input dark:bg-gray-700 dark:text-gray-200 mt-2 w-full" step="1" min="0" max="99999" value="{{$measurement->fec}}" type="number" name="fec" id="measurement_fec">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="input-group">
                            <input class="form-input dark:bg-gray-700 dark:text-gray-200 mt-2  w-full" step="1" min="0" max="300" value="{{$measurement->heart_rate}}" type="number" name="heart_rate" id="measurement_heart_rate">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="input-group">
                            <input class="form-input dark:bg-gray-700 dark:text-gray-200 mt-2 w-full" step="1" min="0" max="100" value="{{$measurement->respiratory_rate}}" type="number" name="respiratory_rate" id="measurement_respiratory_rate">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="input-group">
                            <input class="form-input dark:bg-gray-700 dark:text-gray-200 mt-2 w-full" step="1" min="0" max="300" value="{{$measurement->systolic_bp}}" type="number" name="systolic_bp" id="measurement_systolic_bp">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="input-group">
                            <input class="form-input dark:bg-gray-700 dark:text-gray-200 mt-2 w-full" step="1" min="0" max="200" value="{{$measurement->diastolic_bp}}" type="number" name="diastolic_bp" id="measurement_diastolic_bp">
                            <span class="font-serif dark:text-gray-200  input-group-addon">mmHg</span>
                        </div>
                    </div>
                    <div class="mb-4">
                        ...
                        <div class="input-group">
                            <input class="form-input dark:bg-gray-700 dark:text-gray-200 mt-2 w-full" step=".1" min="0" max="100" value="{{$measurement->pulse_oximetry}}" type="number" name="pulse_oximetry" id="measurement_pulse_oximetry">
                    ...
                    <div class="mb-4">
                        ...
                        <input class="form-input dark:bg-gray-700 dark:text-gray-200 mt-2 w-full" value="{{$measurement->date}}" type="date" name="date" id="measurement_date">
                    </div>
...
<hr class="mt-4">
                    <div class="flex justify-end  mt-6">
                        <button type="button" class="px-3 py-2 text-sm mr-4 mb-4 dark:text-gray-100  tracking-wide text-white capitalize transition-colors duration-200 transform bg-red-500 rounded-md dark:bg-indigo-600 dark:hover:bg-indigo-700 dark:focus:bg-indigo-700 hover:bg-indigo-600 focus:outline-none focus:bg-indigo-500 focus:ring focus:ring-indigo-300 focus:ring-opacity-50">
                            ...
                            <a href="{{ route('animals.showmeasurement', ['animal_id' => $animal->id]) }}" class="btn btn-gray-500">Cancel</a>
                        </button>
