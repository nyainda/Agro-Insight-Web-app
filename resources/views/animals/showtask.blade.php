            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-3">
              ...
              <li>
                <div class="flex items-center">
                  ...
                  <a href="{{route('animals.showtask', $animal->id)}}" class="ml-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ml-2 dark:text-gray-400 dark:hover:text-white">{{$animal->name}}</a>
                </div>
              </li>
    ...
    <div class="container mx-auto p-6 space-y-6">
        ...
        <div class="mb-4 flex flex-col font-serif sm:flex-row justify-between items-center">
            <div class="mb-2 sm:mb-0">
                <a class="bg-green-500 text-white px-4 py-2 rounded-md hover:bg-green-600 font-serif  transition duration-300 ease-in-out" data-remote="true" href="{{ route('animals.task', ['animal_id' => $animal->id]) }}">New tasks</a>
            </div>
            <div class="sm:ml-2">
       ...
       {{--}} <caption class="p-5 text-lg font-semibold text-left text-gray-900 bg-white dark:text-white dark:bg-gray-800">
        ...
        <tbody>
            ...
            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                ...
                <td class="px-6 font-serif py-4">
                    <a href="{{ route('animals.taskedit', ['animal_id' => $animal->id, 'task_id' => $task->id]) }}" class="font-medium font-serif text-blue-600 dark:text-blue-500 hover:underline">Edit</a>
                    <a href="{{ route('task.delete', ['animal_id' => $animal->id, 'task_id' => $task->id]) }}" class="font-medium text-red-600 font-serif dark:text-red-500 hover:underline">Delete</a>
